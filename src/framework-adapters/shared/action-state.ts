...
export const initialActionState: ActionState<unknown> = {
    data: null,
    error: null,
    loading: false,
    isIdle: true,
 ...
 */
export async function runAction<TArgs extends unknown[], TResult>(
 ...
 * at the call site.
 */
export async function runOptimisticAction<TArgs extends unknown[], TResult, TSnapshot>(
    args: {
