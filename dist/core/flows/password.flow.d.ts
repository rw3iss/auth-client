...
export declare class PasswordFlow {
     ...
     */
    requestReset(req: RequestPasswordResetRequest): Promise<void>;
    /**
     ...
     */
    reset(req: ResetPasswordRequest): Promise<void>;
    /**
     ...
     */
    change(req: ChangePasswordRequest): Promise<void>;
}
