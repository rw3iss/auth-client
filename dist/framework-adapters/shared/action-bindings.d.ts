...
export declare const ACTION_BINDINGS: {
    ...
    readonly getUsersBulk: (client: AuthClient) => (req: {
        emails?: string[];
        ids?: string[];
    }) => Promise<import("@rw3iss/auth-shared").LookupUserRecord[]>;
    ...
    readonly getOrg: (client: AuthClient) => (orgId: string) => Promise<import("@rw3iss/auth-shared").Organization>;
    readonly updateOrg: (client: AuthClient) => (params: {
        orgId: string;
        body: import("../../core/flows/org.flow.js").UpdateOrgRequest;
    }) => Promise<import("@rw3iss/auth-shared").Organization>;
    readonly createOrg: (client: AuthClient) => (body: import("../../core/flows/org.flow.js").CreateOrgRequest) => Promise<import("@rw3iss/auth-shared").Organization>;
    ...
    readonly adminGetOrg: (client: AuthClient) => (orgId: string) => Promise<import("@rw3iss/auth-shared").Organization>;
    readonly adminUpdateOrg: (client: AuthClient) => (params: {
        orgId: string;
        body: import("../../core/flows/org.flow.js").UpdateOrgRequest;
    }) => Promise<import("@rw3iss/auth-shared").Organization>;
    readonly adminListOrgMembers: (client: AuthClient) => (orgId: string) => Promise<import("@rw3iss/auth-shared").OrgMemberRecord[]>;
    readonly adminSetOrgMemberRoles: (client: AuthClient) => (params: {
        orgId: string;
        userId: string;
        roleCodes: string[];
    }) => Promise<import("@rw3iss/auth-shared").OrgMemberRecord>;
    readonly listOrgMembers: (client: AuthClient) => (orgId: string) => Promise<import("@rw3iss/auth-shared").OrgMemberRecord[]>;
    ...
    readonly listOrgRoles: (client: AuthClient) => (orgId: string) => Promise<import("@rw3iss/auth-shared").OrgRoleRecord[]>;
    readonly getOrgRole: (client: AuthClient) => (params: {
        orgId: string;
        roleId: string;
    }) => Promise<import("@rw3iss/auth-shared").OrgRoleRecord>;
    ...
    readonly listAssignablePermissions: (client: AuthClient) => (orgId: string) => Promise<import("@rw3iss/auth-shared").AssignablePermissionRecord[]>;
    readonly createInvitation: (client: AuthClient) => (params: {
        orgId: string;
        body: import("../../core/flows/org.flow.js").CreateInvitationRequest;
    }) => Promise<import("@rw3iss/auth-shared").InvitationRecord>;
    readonly listOrgInvitations: (client: AuthClient) => (orgId: string) => Promise<import("@rw3iss/auth-shared").InvitationRecord[]>;
    readonly revokeInvitation: (client: AuthClient) => (params: {
        orgId: string;
        invitationId: string;
    }) => Promise<void>;
    readonly listMyInvitations: (client: AuthClient) => () => Promise<import("@rw3iss/auth-shared").InvitationRecord[]>;
    readonly acceptInvitation: (client: AuthClient) => (invitationId: string) => Promise<import("@rw3iss/auth-shared").Organization | null>;
    ...
    readonly getRegistrationPolicy: (client: AuthClient) => (appCode?: string) => Promise<import("@rw3iss/auth-shared").RegistrationPolicy>;
    ...
    readonly adminListUserSessions: (client: AuthClient) => (userId: string) => Promise<import("@rw3iss/auth-shared").SessionRecord[]>;
    ...
    readonly listAuditLog: (client: AuthClient) => (q?: import("../../core/flows/audit-log.flow.js").AuditLogQuery) => Promise<import("@rw3iss/auth-shared").AuditLogResult>;
    ...
    readonly listAllOrgs: (client: AuthClient) => () => Promise<import("@rw3iss/auth-shared").Organization[]>;
    readonly listApps: (client: AuthClient) => () => Promise<import("@rw3iss/auth-shared").AppRecord[]>;
    readonly getApp: (client: AuthClient) => (appId: string) => Promise<import("@rw3iss/auth-shared").AppRecord>;
    readonly createApp: (client: AuthClient) => (body: import("../../core/flows/apps.flow.js").CreateAppRequest) => Promise<import("@rw3iss/auth-shared").AppRecord>;
    readonly updateApp: (client: AuthClient) => (params: {
        appId: string;
        body: import("../../core/flows/apps.flow.js").UpdateAppRequest;
    }) => Promise<import("@rw3iss/auth-shared").AppRecord>;
    readonly deleteApp: (client: AuthClient) => (appId: string) => Promise<void>;
    readonly listNamespaces: (client: AuthClient) => (opts?: {
        forceRefresh?: boolean;
    }) => Promise<import("@rw3iss/auth-shared").NamespaceInfo[]>;
    readonly getUserNamespaces: (client: AuthClient) => (userId: string) => Promise<import("@rw3iss/auth-shared").UserNamespacesResponse>;
    ...
    readonly adminListUserApps: (client: AuthClient) => (userId: string) => Promise<import("@rw3iss/auth-shared").AppRecord[]>;
    ...
    readonly adminGetUserOrganizations: (client: AuthClient) => (userId: string) => Promise<import("@rw3iss/auth-shared").AdminUserOrgMembership[]>;
    ...
    readonly listM2MClients: (client: AuthClient) => () => Promise<import("@rw3iss/auth-shared").M2MClientRecord[]>;
    readonly getM2MClient: (client: AuthClient) => (id: string) => Promise<import("@rw3iss/auth-shared").M2MClientRecord>;
    readonly createM2MClient: (client: AuthClient) => (body: import("../../core/flows/m2m.flow.js").CreateM2MClientRequest) => Promise<import("@rw3iss/auth-shared").CreateM2MClientResponse>;
