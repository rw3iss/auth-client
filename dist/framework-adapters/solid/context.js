 ...
 * build for this file.
 */
import { createComponent, createContext, createSignal, onCleanup, onMount, useContext, } from 'solid-js';
...
export function AuthProvider(props) {
    const [snapshot, setSnapshot] = createSignal(props.client.getSnapshot());
    onMount(() => {
